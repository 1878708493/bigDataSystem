...
public class Database {
	...
	public boolean updateRemainDevice(String app_key, String date, String today, String oneday, 
			String twoday, String threeday, String fourday, String fiveday, String sixday, String sevenday) {
		int i = 0;
		try {
			...
			if(i > 0){	// 有这条数据,只用更新就行
				...
				str = "insert into survive_device(app_key, today, 1day, 2day, 3day, 4day, 5day, 6day, 7day, date)values('" + 
						app_key + "', '" + today + "', '" + oneday + "', '" + twoday + "', '" + 
						threeday + "', '" + fourday + "', '" + fiveday + "', '" + sixday + "', '" + 
						sevenday + "', '" + date + "')"; 
				state.executeUpdate(str);
				state.close();
			}
	...
	public boolean updateRemainUser(String app_key, String date, String today, String oneday, 
			String twoday, String threeday, String fourday, String fiveday, String sixday, String sevenday) {
		int i = 0;
		try {
	...
	public boolean updateArea(String app_key, String area, String newDevCount, String newUserCount, String date) {
		...
		try {
			...
			if(i > 0){	// 有这条数据,只用更新就行
				...
				str = "insert into area(app_key, area, new_dev_count, new_user_count, date)values('" + 
						app_key + "', '" + area + "', '" + newDevCount + "', '" + newUserCount + "', '" + 
						date + "')";
				state.executeUpdate(str);
				state.close();
			}
	...
	public boolean updateActiveDevice(String app_key, String one, String twoToThree, String fourToSeven,
		...
		try {
			...
			if(i > 0){	// 有这条数据,只用更新就行
				str = "update active_device set " + "1d='" + one + "', " + "2_3d='" + twoToThree + "', " + 
						"4_7d='" + fourToSeven + "', " + "8_14d='" + eightToFourteen + "', " +
						"15_30d='" + fifteenToThirty + "', " + "31_90d='" + ThirtyOneToNinty + "'";
				...
				str = "insert into active_device(app_key, 1d, 2_3d, 4_7d, 8_14d, 15_30d, 31_90d)values('" + 
						app_key + "', '" + one + "', '" + twoToThree + "', '" + fourToSeven + "', '" + 
						eightToFourteen + "', '" + fifteenToThirty + "', '" + ThirtyOneToNinty + "')";
				state.executeUpdate(str);
				state.close();
			}
		} catch (SQLException e) {
	...
	try {
		...
		if(i > 0){	// 有这条数据,只用更新就行
			str = "update active_user set " + "1d='" + one + "', " + "2_3d='" + twoToThree + "', " + 
					"4_7d='" + fourToSeven + "', " + "8_14d='" + eightToFourteen + "', " +
					"15_30d='" + fifteenToThirty + "', " + "31_90d='" + ThirtyOneToNinty + "'";
			str = str.concat(" where app_key='" + app_key + "'");
			//System.out.println(str);
			...
			str = "insert into active_user(app_key, 1d, 2_3d, 4_7d, 8_14d, 15_30d, 31_90d)values('" + 
					app_key + "', '" + one + "', '" + twoToThree + "', '" + fourToSeven + "', '" + 
					eightToFourteen + "', '" + fifteenToThirty + "', '" + ThirtyOneToNinty + "')";
			state.executeUpdate(str);
			state.close();
